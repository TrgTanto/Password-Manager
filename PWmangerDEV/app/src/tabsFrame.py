...
class tabsFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.appIcon = ctk.CTkLabel(master=self,
            text="",
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/inApp.png"), size=(45, 45)),
        )
        ...
        self.passwordFrameButton = ctk.CTkButton(master=self,
            ...
            width=225,
            height=40,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/passwordButton.png"), size=(25, 25)),
            anchor="w",
        ...
        self.generatorFrameButton = ctk.CTkButton(master=self,
            ...
            width=225,
            height=40,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/generatorButton.png"), size=(25, 25)),
            anchor="w",
            font=("Roboto Medium", 15),
            text_color="#8E97A8",
            corner_radius=4,
        ...
        self.checkerFrameButton = ctk.CTkButton(master=self,
            ...
            width=225,
            height=40,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/checkerButton.png"), size=(25, 25)),
            anchor="w",
            font=("Roboto Medium", 15),
            text_color="#8E97A8",
            corner_radius=4,
        ...
        self.calculatorFrameButton = ctk.CTkButton(master=self,
            ...
            width=225,
            height=40,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/calculatorButton.png"), size=(25, 25)),
            anchor="w",
            font=("Roboto Medium", 15),
            text_color="#8E97A8",
            corner_radius=4,
