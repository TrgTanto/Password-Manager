...
class passwordFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.createNewEntry = ctk.CTkButton(master=self.passwordsListSettingsFrame,
            text="Neuer Eintrag",
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/plusButton.png")),
        ...
        self.zeroEntries = ctk.CTkLabel(master=self.passwordsListSavedFrame,
            text="",
            image=ctk.CTkImage(dark_image=Image.open('app/icons/png/zeroEntries.png'), size=(100, 100))
        )
        ...
        self.deleteButton = ctk.CTkButton(master=self.passwordInformationFrame,
            width=120,
            height=50,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/calculatorTrashCan.png"), size=(22, 22)),
            text="Löschen",
            font=("Roboto Medium", 16),
            corner_radius=8,
            border_width=1,
    ...
    def createNewPassword(self):
        ...
        closeFrame = ctk.CTkButton(master=newEntyFrame,
            text="",
            image=ctk.CTkImage(dark_image=Image.open('app/icons/png/closeButton.png'), size=(35, 35)),
            fg_color="transparent",
            hover_color="#232D38",
            width=40,
            height=40,
        ...
        saveButton = ctk.CTkButton(master=newEntyFrame,
            width=150,
            height=45,
            image=ctk.CTkImage(dark_image=Image.open("app/icons/png/savePassword.png"), size=(20, 20)),
            text="Speichern",
            font=("Roboto Medium", 16),
            corner_radius=8,
            border_width=1,
    ...
    def createButton(self, entry_id, enterName, username, password, url, notes):
        ...
        if enterName in nameLists:
            checkImage = ctk.CTkImage(dark_image=Image.open((f"app/icons/png/appPngs/{enterName}.png")), size=(50,50 ))
        else:
            checkImage = ctk.CTkImage(dark_image=Image.open((f"app/icons/png/appPngs/notInnamelists.png")), size=(50,50 ))
