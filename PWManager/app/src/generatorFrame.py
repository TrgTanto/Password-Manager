...
HISTORY_FILE = get_data_path("password_history.json")
...
class generatorFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.generateButton = ctk.CTkButton(master=self.generateFrame,
            ...
            hover_color="#112758",
            font=("Roboto Medium", 14),
            image=ctk.CTkImage(dark_image=Image.open(resource_path('icons/png/overviewGeneratorGenerate.png')), size=(20, 20)),
        ...
        self.analysisDeleteHistory = ctk.CTkButton(master=self.analysisFrame,
            ...
            hover_color="#112758",
            font=("Roboto Medium", 14),
            image=ctk.CTkImage(dark_image=Image.open(resource_path('icons/png/calculatorTrashCan.png')), size=(20, 20)),
    ...
    def generatePassword(self):
        ...
        if lenPw >= 16:
            self.analysisLengthText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
        else:
            self.analysisLengthText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        
        if any(c in pw for c in string.ascii_uppercase):
            self.analysisUpLetterText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
        else:
            self.analysisUpLetterText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        
        if any(c in pw for c in string.ascii_lowercase):
            self.analysisLowLetterText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
        else:
            self.analysisLowLetterText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        
        if any(c in pw for c in string.digits):
            self.analysisNumberText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
        else:
            self.analysisNumberText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        
        if any(c in pw for c in string.punctuation):
            self.analysisPuncsText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
        else:
            self.analysisPuncsText.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
