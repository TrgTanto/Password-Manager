...
unkownIcon =  'icons/png/unkownIcon.png'
checkIcon = 'icons/png/checkIcon.png'
noCheckIcon = 'icons/png/noCheckIcon.png'

HISTORY_FILE = get_data_path("checker_history.json")
...
class checkerFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.checkStrengthButton = ctk.CTkButton(master=self.enterPasswordFrame,
            ...
            fg_color="#032A82",
            hover_color="#07329B",
            image=ctk.CTkImage(dark_image=Image.open(resource_path("icons/png/checkPasswordButton.png")), size=(25, 25)),
        ...
        self.analysisLengthCheck = ctk.CTkButton(master=self.analysisFrame,
            ...
            corner_radius=0,
            text_color="#777477",
            image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)),
        ...
        self.recommendationLength = ctk.CTkButton(master=self.recommendationFrame,
            ...
            hover="disabled",
            fg_color="transparent",
            image=ctk.CTkImage(dark_image=Image.open(resource_path("icons/png/missing.png")), size=(25, 25))
        )
        ...
        self.deleteHistoryButton = ctk.CTkButton(master=self.historyFrame,
            ...
            fg_color="#032A82",
            hover_color="#07329B",
            image=ctk.CTkImage(dark_image=Image.open(resource_path("icons/png/calculatorTrashCan.png")), size=(25, 25)),
        ...
        self.tipFrame = ctk.CTkButton(master=self,
            ...
            border_color="#19232F",
            hover="disabled",
            image=ctk.CTkImage(dark_image=Image.open(resource_path('icons/png/proTipIcon.png')), size=(35, 35)),
            font=("Segoe UI", 12),
        )
    ...
    def checkPasswordStrength(self):
        ...
        if lenPassword == 0:
            ...
            self.analysisLengthCheck.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)))
            self.analysisUppercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)))
            self.analysisLowercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)))
            self.analysisNumbers.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)))
            self.analysisPuncs.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(unkownIcon)), size=(25, 25)))
            return
        ...
        if lenPassword >= 16:
            self.analysisLengthCheck.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
            self.recommendationLength.place_forget()
        else:
            self.analysisLengthCheck.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        ...
        if any(c in checkedPassword for c in string.ascii_uppercase):
            self.analysisUppercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
            self.recommendationUppercase.place_forget()
        else:
            self.analysisUppercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
        ...
        if any(c in checkedPassword for c in string.ascii_lowercase):
            self.analysisLowercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
            self.recommendationLowercase.place_forget()
        else:
            self.analysisLowercase.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
            self.recommendationLowercase.place(anchor="center", relx=0.305, rely=0.6)
        
        if any(c in checkedPassword for c in string.digits):
            self.analysisNumbers.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
            self.recommendationDigits.place_forget()
        else:
            self.analysisNumbers.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
            self.recommendationDigits.place(anchor="center", relx=0.23, rely=0.75)
        
        if any(c in checkedPassword for c in string.punctuation):
            self.analysisPuncs.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(checkIcon)), size=(25, 25)))
            self.recommendationPuncs.place_forget()
        else:
            self.analysisPuncs.configure(image=ctk.CTkImage(dark_image=Image.open(resource_path(noCheckIcon)), size=(25, 25)))
